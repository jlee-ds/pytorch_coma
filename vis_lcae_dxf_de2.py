...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--split', default='lgtddxf', help='split can be lgtddxb or lgtddxf')
    parser.add_argument('-st', '--split_term', default='lgtddxf', help='split can be lgtddxb or lgtddxf')
