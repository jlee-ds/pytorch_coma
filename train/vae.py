...
def main(args):
    ...
    print('current device: ', torch.cuda.current_device()) if torch.cuda.is_available() else print('no cuda, just cpu')
    ...
    writer = SummaryWriter(log_dir+'ds4_lr0.008_z8_kld_v5')
    print(coma.z)
...
def train(coma, train_loader, len_dataset, optimizer, device, epoch):
    ...
    for data in tqdm(train_loader):
        ...
        kld_weight = float(1/(1+np.exp(-0.0004*(iteration - 45000))))
