...
def main(args):
    ...
    log_dir = os.path.join('runs/lcae_dxb_de2', current_time)
    writer = SummaryWriter(log_dir+'_lr0.08_wd0.0008_ds2_e3')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--conf', default='cfgs/lcae_dx_de2.cfg', help='path of config file')
    parser.add_argument('-s', '--split', default='lgtddxb', help='split can be gnrt, clsf, or lgtd')
    parser.add_argument('-st', '--split_term', default='lgtddxb', help='split can be gnrt, clsf, or lgtd')
